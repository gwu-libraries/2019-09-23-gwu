...
address: "Rooms 301/302 @ Gelman Library, 2130 H St NW, Washington, DC"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "Sep 23-24, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
email: ["lwrubel@gwu.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
